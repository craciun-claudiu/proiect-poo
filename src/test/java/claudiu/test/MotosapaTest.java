...
public class MotosapaTest {
    ...
    public static void main(String[] args) {
        ...
        //Motosapele cu o greutate mai mica de 30 de kg si cu pornire manuala
        System.out.println("Motosapele cu o greutate mai mica de 30 de kg si cu pornire manuala");
        for(int i = 0 ; i < 10 ; i++){
            if(v[i].getGreutate() <= 30f && v[i].getTipPornire().compareTo("Manuală") == 0)
